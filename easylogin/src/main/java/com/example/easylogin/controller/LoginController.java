...
public class LoginController {
	...
	/*
	 * @ResponseBody // (Lesson06) //
	 *  public String showUsers() { //return "Test";
	 * List<User> users = userRepos.findAll(); User user = users.get(0); String info
	 * = user.getUserName() + " " + user.getPassword(); return info; }
	 */
	  ...
	  if(users.size() > 0) { User user = users.get(0); message +=
	  user.getFullName(); }else { message += "guest"; }
